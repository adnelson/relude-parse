...
describe("ReludeParse_Parser", () => {
  ...
  test(">>= nested", () => {
    let p = \">>="(P.anyDigit, a =>
      \">>="(P.anyDigit, b => \">>="(P.anyDigit, c => \"<#>"(P.anyDigit, d => (a, b, c, d))))
    )
  ...
  test("lookAhead preserves the position mid-parse", () =>
    testParse(
      \">>="(P.times(3, P.anyDigit), first =>
        P.lookAhead(\"<#>"(P.times(3, P.anyDigit), second => (first, second)))
      ),
      "012345",
  ...
  test("orDefault default", () =>
    testParse(P.anyDigit |> P.orDefault("!"), "x", "!", {pos: 0, str: "x"}) // TODO: not sure if pos should be advanced here?
  )
  ...
  testAll(
    ...
    ((input, expected, pos)) =>
      testParse(\"<*"(P.anyUnsignedInt, P.eof), input, expected, {pos: pos, str: input}),
  )
  ...
  testAll(
    ...
    ((input, expected, pos)) =>
      testParse(\"<*"(P.anyPositiveInt, P.eof), input, expected, {pos: pos, str: input}),
  )
  ...
  testAll(
    ...
    ((input, expected, pos)) =>
      testParse(\"<*"(P.anyNegativeInt, P.eof), input, expected, {pos: pos, str: input}),
  )
  ...
  testAll(
    ...
    ((input, expected, pos)) =>
      testParse(\"<*"(P.anyInt, P.eof), input, expected, {pos: pos, str: input}),
  )
  ...
  testAll(
    ...
    ((str, expected, pos)) =>
      testParse(\"<*"(P.anyDecimal, P.eof), str, expected, {pos: pos, str: str}),
  )
  ...
  testAll("boolTrue", list{("true", true, 4), ("TRUE", true, 4), ("TrUe", true, 4)}, ((
    ...
    exp,
    pos,
  )) => testParse(\"<*"(P.boolTrue, P.eof), str, exp, {str: str, pos: pos}))

  testAll("boolFalse", list{("false", false, 5), ("FALSE", false, 5), ("fALse", false, 5)}, ((
    str,
    exp,
    pos,
  )) => testParse(\"<*"(P.boolFalse, P.eof), str, exp, {str: str, pos: pos}))
  ...
  testAll(
    ...
    ((str, exp, pos)) => testParse(\"<*"(P.anyBool, P.eof), str, exp, {str: str, pos: pos}),
  )
  ...
  testAll(
    ...
    ((str, regex, expected, pos)) => testParse(P.regex(regex), str, expected, {pos: pos, str: str}),
  )
  ...
  testAll(
    ...
    ((str, regexString, flags, expected, pos)) =>
      testParse(P.regexStr(regexString, ~flags), str, expected, {pos: pos, str: str}),
  )
